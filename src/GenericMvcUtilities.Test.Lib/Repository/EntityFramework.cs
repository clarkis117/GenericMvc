...
{
	public abstract class BaseEntityFramework<TEntity, TContext> : Lib.EntityFrameworkRepository
		where TEntity : class, new()
		where TContext : InMemoryDbContext
	{
		private static readonly int[] _ranges = new int[] { 1, 2, 5, 10, 25, 50 };

		private IDatabaseTestFixture<TEntity> Fixture;

		//protected List<TEntity> DataToCleanUp;

		protected BaseEntityFrameworkRepository<TEntity> Repo;

		public BaseEntityFramework()
		{
			var fixture = new InMemoryDataBaseFixture<TEntity, TContext>();
